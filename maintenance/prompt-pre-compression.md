You are helping prepare instructions for a compression.

The final instructions must fit within an 8000 character limit.

This process protects the behavioral integrity of the instructions while compressing them to fit the limit.
